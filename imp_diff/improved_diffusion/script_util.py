...
from .respace_sum import SpacedDiffusionSum
from .unet import SuperResModel, UNetModel
from .transformer_model import TransformerNetModel3
from . import gaussian_diffusion_sum as gd
from .respace_sum import space_timesteps
...
def create_model_and_diffusion(
    ...
    **kwargs,
    ...
    print("Model Arch: {}".format(model_arch))
    print("Training Model: {}".format(training_mode))
    print("Exp Mode: {}".format(experiment_mode))
    print("Logits_Mode: {}".format(logits_mode))
    print("Use KL: {}".format(use_kl))
    print("Predict XStart: {}".format(predict_xstart))
    print("Rescale Time Steps: {}".format(rescale_timesteps))
    print("Time Step Respcaing: {}".format(timestep_respacing))
